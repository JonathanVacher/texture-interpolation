    ...
    def get_net_and_loss(self):
        ...
        for layer in self.cnn.children():
            ...
            if name in self.tex_layers:
                ...
                tex_loss_1 = utils.TexLossGram(target_feature_1, self.device)
                tex_loss_2 = utils.TexLossGram(target_feature_2, self.device)
        ...
        for i in range(len(self.model) - 1, -1, -1):
            if isinstance(self.model[i], utils.TexLossGram):
                break
